...
class Ui_Login(object):
    def setupUi(self, Login):
        ...
        Login.resize(325, 100)
        Login.setMinimumSize(QtCore.QSize(325, 100))
        Login.setMaximumSize(QtCore.QSize(325, 100))
        self.layoutWidget = QtWidgets.QWidget(parent=Login)
        self.layoutWidget.setGeometry(QtCore.QRect(0, 0, 321, 120))
